...
addZip();*/
  ...
  function initializeRows() {
    ...
    function createNewRow(room) {
      ...
      console.log(room.Hotel.hotel_name);
      ...
      // //APPEND TO CELL
      // var DetailsModalButton = $(
      //   "<button id=viewProperty" +
      //     [i] +
      //     " " +
      //     "class='waves-effect waves-light btn modal-trigger indigo lighten-4' data-target=#details" +
      //     [i] +
      //     ">"
      // );
      ...
      // //APPEND TO CELL
      // var DetailsDiv1 = $(
      //   "<div id=details" + [i] + " " + "class='modal wordWrap'>"
      // );
      // DetailsCell.append(DetailsDiv1);
      // //APPEND TO DIV1
      // var DetailsDiv2 = $(
      //   "<div class='modal-content property-details left-align'>"
      // );
      ...
      // var webLink = $(
      //   "<a href=" + this.url + " " + "style='cursor:pointer' target='_blank'>"
      // );
      ...
      // //APPEND TO CELL
      // var DescriptionModalButton = $(
      //   "<a id=roomModal" +
      //     [i] +
      //     " " +
      //     "class='waves-effect waves-light btn modal-trigger indigo lighten-4' href=#room" +
      //     [i] +
      //     ">"
      // );
      ...
      // //APPEND TO CELL
      // var DescriptionDiv1 = $(
      //   "<div id=room" + [i] + " " + " class='modal wordWrap'>"
      // );
      // DescriptionCell.append(DescriptionDiv1);
      // //APPEND TO DIV1
      // var DescriptionDiv2 = $(
      //   "<div class='modal-content room-details left-align'>"
      // );
      ...
      // //APPEND TO LABEL
      // var DescriptionSpan = $(
      //   "<span id='descr" + [i] + " " + "class='wordWrap'>"
      // );
